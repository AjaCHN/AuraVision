  ...
  return (
    <>
      ...
      <div className="p-4 space-y-6 border-b lg:border-b-0 lg:border-r border-white/5">
        ...
        <button onClick={resetAudioSettings} className="w-full py-2.5 mt-2 bg-white/[0.04] rounded-lg text-xs font-bold uppercase tracking-widest text-white/50 hover:text-white hover:bg-white/[0.08] transition-all flex items-center justify-center gap-2">
